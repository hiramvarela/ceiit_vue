<template>
                ...
                >
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <b-button v-if="result.status" @click="makeLoan(result)" variant="info" class="ml-2">Make Loan</b-button>
                    </div>
                  </div>
                </b-list-group-item>
              </b-list-group>
  ...
  export default {
    ...
    methods: {
      ...
      async makeLoan(result) {
        // Here, you can perform any logic related to making a loan based on the 'result' data.
        // For example, you can pass the necessary data to the '/addUser' route.
        // After that, navigate to the '/addUser' route.
        this.$router.push({ name: 'addUser', params: { userId: result.userId } });
      }
    }
  };
  </script>
  ...
  .list-group-item-success {
    background-color: #d4edda; /* Light green background for available items */
  }
